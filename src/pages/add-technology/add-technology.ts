...
@Component({ 
  ...
  export class AddTechnologyPage { 
    ...
    /* @name form * @type {FormGroup} @public * @description Define FormGroup property for managing form validation / data retrieval */ 
    
    public form : FormGroup; 
    /* @name technologyName * @type {Any} * @public * @description Model for managing technologyName field */ 
    
    public technologyName : any; 
    /* @name technologyDescription * @type {Any} * @public * @description Model for managing technologyDescription field */ 
    
    public technologyDescription : any; 
    
    /* @name isEdited * @type {Boolean} * @public * @description Flag to be used for checking whether we are adding/editing an entry */ 
    
    public isEdited : boolean = false; 
    /* @name hideForm * @type {Boolean} * @public * @description Flag to hide the form upon successful completion of remote operation */ 
    
    public hideForm : boolean = false; 
    /* @name pageTitle * @type {String} * @public * @description Property to help set the page title */ 
    ...
    constructor(public navCtrl : NavController, public http : HttpClient, public NP : NavParams, public fb : FormBuilder, public toastCtrl : ToastController) { 
      ...
      this.form = fb.group({ "name" : ["", Validators.required], "description" : ["", Validators.required] }); 
    } 
    
    /** * Triggered when template view is about to be entered * Determine whether we adding or editing a record * based on any supplied navigation parameters  */ 
    ...
    ionViewWillEnter() : void { 
      ...
      if(this.NP.get("record")) { 
        ...
        this.pageTitle = 'Amend entry';
         ...
         this.isEdited = false; this.pageTitle = 'Create entry'; 
        } 
      } 
      
      /** * Assign the navigation retrieved data to properties * used as models on the page's HTML form *  {any} Navigation data *  */ 
      ...
      /** * Save a new record that has been added to the page's HTML form * Use angular's http post method to submit the record data * * ntry  {String} Name value from form field *{String} Description value from form field *  */ 
      ...
      createEntry(name : string, description : string) : void { 
        ...
        updateEntry(name : string, description : string) : void { 
          ...
          /** * Remove an existing record that has been selected in the page's HTML form * Use angular's http post method to submit the record data * to our remote PHP script * * */ 
          ...
          /** * Handle data submitted from the page's HTML form * Determine whether we are adding a new record or amending an * existing record * *  */ 
          
          saveEntry() : void { 
            let name : string = this.form.controls["name"].value, description : string = this.form.controls["description"].value; 
            if(this.isEdited) { this.updateEntry(name, description); } else { this.createEntry(name, description); 
            ...
            /** * Manage notifying the user of the outcome of remote operations * * {String} Message to be displayed in the notification *  */ 
